    ...
    <Layout>
      ...
      <section className="text-center py-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-6">
          <Image src="/play.png" alt="Coming soon to Google Play" width={180} height={55} className="w-40 sm:w-44 md:w-48" />
          <Image src="/app.png" alt="Coming soon to the App Store" width={180} height={55} className="w-40 sm:w-44 md:w-48" />
        </div>
      </section>
